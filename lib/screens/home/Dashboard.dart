    ...
    return Scaffold(
      ...
      body: PageView(
        ...
        children: <Widget>[
          ...
          Center(
            child: DashboardOnePage(),
          ),
          Column(
            children: [
              Text(widget.loginUser.email),
              RaisedButton(
                onPressed: () {
          ...
          builder: (context, snapshot) {
            ...
            return FancyBottomNavigation(
              ...
              items: <FancyBottomNavigationItem>[
                ...
                FancyBottomNavigationItem(
                    icon: Icon(Icons.menu), title: Text('Dashboard')),
                FancyBottomNavigationItem(
